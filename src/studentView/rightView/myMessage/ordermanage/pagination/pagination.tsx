...
interface IPaginationViewProps {
    GlobalOrderManagementDoMainStore: OrderManagementviewDoMainStore
}
...
export class PaginationView extends React.Component<IPaginationViewProps>{
    ...
    public render() {
        const { allReportTableData, paginationOnChange, paginationPageSizeMenuOnClick, PageSize, PageIndex } = this.props.GlobalOrderManagementDoMainStore;
        ...
        return (
            <div className="ori-table-pagination" style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ display: 'block', paddingLeft: '2rem', width: "50%" }}>
