...
const formCreateOption: FormCreateOption<IMiddleFromViewProps> = {
    mapPropsToFields(props) {
        if(props.GlobalTadayRecommendDomainStore!.List.length>0){
            const lengths = props.GlobalTadayRecommendDomainStore!.lengths;
            const item = props.GlobalTadayRecommendDomainStore!.List[lengths];
            return {
