...
import { UnidentifiedOrderTableUiAction } from "./uiAction";
...
@observer
export class UnidentifiedOrderTable extends React.Component<IUnidentifiedOrderTableProps>{

    private uiAction: UnidentifiedOrderTableUiAction;
    ...
    constructor(props: IUnidentifiedOrderTableProps) {
        super(props);
        this.uiAction = new UnidentifiedOrderTableUiAction(props);
    }
    ...
    public render() {
        return (
            <Table
                ...
                dataSource={this.props.GlobalOnlineOrderDoMainStore!.allReportTableData1.slice()}
            />
        )
    }
}