...
interface IPaginationViewProps {
    GlobalCustomerListDomainStores: StudentListDomainStores;
}
...
export class PaginationView extends React.Component<IPaginationViewProps>{
    ...
    public render() {
        const { allReportTableData, paginationOnChange, paginationPageSizeMenuOnClick, PageSize, PageIndex } = this.props.GlobalCustomerListDomainStores;
