/**
 * 检查并返回当前http请求的response。
 * @param   {Response} response http response 
 * @returns {Response} 如果response 正常，则返回当前response,如果有错误，则抛出异常
 */
...
/** 
 * 将当前 http response 解析为 json格式的对象
 * @param   {Response} response http response 
...
/**
 * http fetch 的封装函数。请求指定的url,返回可用于异步出的Promise对象
 * 
 * @param  {string} url       请求的url,可以是任何可用的web url，相对url或完整url。如果是相对url，要相对于站点，而不是相对于当前使用的文件
 * @param  {object} [options] 当前fetch的配置选项
 * @return {Promise<IResponseResult>}         
 */
